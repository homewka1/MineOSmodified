...
applications = serialization.unserialize(getFromGitHubSafely(GitHubUserUrl .. "SaratovProject/MineOSmodified/master/Applications.txt", "/MineOS/System/OS/Applications.txt"))
print(" ")
...
do
  ...
  getFromGitHubSafely(GitHubUserUrl .. "SaratovProject/MineOSmodified/master/Installer/" .. _G.OSSettings.language .. ".lang", pathToLang)
  getFromGitHubSafely(GitHubUserUrl .. "SaratovProject/MineOSmodified/master/MineOS/License/" .. _G.OSSettings.language .. ".txt", "/MineOS/System/OS/License.txt")
