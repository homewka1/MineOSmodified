...
local function getECSAPI()
	...
	shell.execute("wget -fQ https://raw.githubusercontent.com/SaratovProject/MineOSmodified/master/lib/ECSAPI.lua lib/ECSAPI.lua")
...
local function getApplicationList()
	...
	shell.execute("wget -fQ https://raw.githubusercontent.com/SaratovProject/MineOSmodified/master/Applications.txt MineOS/System/OS/Applications.txt")
